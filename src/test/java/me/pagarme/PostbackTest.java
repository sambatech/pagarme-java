...
public class PostbackTest extends BaseTest {
    ...
    private static final String SIGNATURE = "sha1=1b66c265fdac6a903d2aecd01290a26a17c246fd";
    ...
    public void testPostbackValidation() throws Throwable {
        Assert.assertTrue(PagarMe.validateRequestSignature(PAYLOAD, SIGNATURE));
    }
}
